...
Runtime: **0 ms**, faster than **100.00%** of JavaScript online submissions for **String to Integer (atoi).**

Memory Usage: **5.7 MB**, less than **72.07%** of JavaScript online submissions for **String to Integer (atoi).**
